...
const Sidebar = ({openSideBar,sideBarOpen}) => {
    return (
        <aside onClick={openSideBar} className={`fixed transition-all duration-300 z-30 ease-in-out bg-main-light w-[100%] h-screen px-8 py-12 flex justify-center items-center ${sideBarOpen ? "left-0":"left-[-100%]"}`}>
            <div className="w-full h-full flex flex-col justify-between text-2xl">
            <div className="flex w-[180px] justify-start pb-2 border-b border-black items-center">
